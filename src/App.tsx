...
const App = () => {
  return (
   <main className="min-h-screen bg-bg-primary text-text-primary">
      ...
      <section className="mx-auto flex max-w-5xl flex-col gap-6 px-6 py-24 relative z-10">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <article className="surface-card hover:border-accent/50 transition-colors duration-300">
            <h2 className="text-lg font-semibold text-text-primary">Fast Styling</h2>
            <p className="mt-2 text-sm text-text-secondary">Use classes directly in TSX.</p>
          </article>
          <article className="surface-card hover:border-accent/50 transition-colors duration-300">
            <h2 className="text-lg font-semibold text-text-primary">Vite Plugin</h2>
            <p className="mt-2 text-sm text-text-secondary">Official Tailwind v4 integration.</p>
          </article>
          <article className="surface-card hover:border-accent/50 transition-colors duration-300">
            <h2 className="text-lg font-semibold text-text-primary">Production Ready</h2>
